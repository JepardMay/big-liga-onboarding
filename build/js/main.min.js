...
/* harmony import */ var _modules_init_nav_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-nav-menu */ "./js/modules/init-nav-menu.js");
...
/* harmony import */ var _modules_show_content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-content */ "./js/modules/show-content.js");
...
Object(_modules_init_nav_menu__WEBPACK_IMPORTED_MODULE_2__["initNavMenu"])();
Object(_modules_show_content__WEBPACK_IMPORTED_MODULE_4__["showContent"])();
...
var loader = document.querySelector('.loader-display');
var loaderBtn = document.querySelector('.loader-display__btn');
...
var initLoader = function initLoader() {
  ...
  if (loader && loaderBtn) {
    loaderBtn.addEventListener('click', function (evt) {
      evt.preventDefault();
      closeLoader();
    });
  }
...
/***/ "./js/modules/init-nav-menu.js":
/*!*************************************!*\
  !*** ./js/modules/init-nav-menu.js ***!
  \*************************************/
/*! exports provided: closeNavMenu, initNavMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeNavMenu", function() { return closeNavMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNavMenu", function() { return initNavMenu; });
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/scroll-lock */ "./js/utils/scroll-lock.js");
/* harmony import */ var _stop_transition_resize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stop-transition-resize */ "./js/modules/stop-transition-resize.js");
/* harmony import */ var _show_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-content */ "./js/modules/show-content.js");



var navMenu = document.querySelector('.main-nav__list');
var navMenuBtn = document.querySelector('.main-nav__toggle');
...
var onClick = function onClick(evt) {
  Object(_show_content__WEBPACK_IMPORTED_MODULE_2__["removeContent"])();
  evt.preventDefault();
...
var initNavMenu = function initNavMenu() {
  if (navMenu && navMenuBtn) {
    ...
    Object(_stop_transition_resize__WEBPACK_IMPORTED_MODULE_1__["stopTransitiononResize"])(navMenu);
  }
};
...
/*!************************************!*\
  !*** ./js/modules/show-content.js ***!
  \************************************/
/*! exports provided: removeContent, showContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/scroll-lock */ "./js/utils/scroll-lock.js");
/* harmony import */ var _stop_transition_resize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stop-transition-resize */ "./js/modules/stop-transition-resize.js");
/* harmony import */ var _init_nav_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./init-nav-menu */ "./js/modules/init-nav-menu.js");



var mainBlock = document.querySelector('.main-block');
var content = document.querySelector('.main-block__column');
...
var onClick = function onClick(evt) {
  if (evt.target.closest('.main-block')) {
    Object(_init_nav_menu__WEBPACK_IMPORTED_MODULE_2__["closeNavMenu"])();
    evt.preventDefault();
...
var showContent = function showContent() {
  if (content) {
    ...
    Object(_stop_transition_resize__WEBPACK_IMPORTED_MODULE_1__["stopTransitiononResize"])(content);
  }
};
...
/***/ "./js/modules/stop-transition-resize.js":
/*!**********************************************!*\
  !*** ./js/modules/stop-transition-resize.js ***!
  \**********************************************/
/*! exports provided: stopTransitiononResize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stopTransitiononResize", function() { return stopTransitiononResize; });
var stopTransitiononResize = function stopTransitiononResize(el) {
  var resizeTimer;
