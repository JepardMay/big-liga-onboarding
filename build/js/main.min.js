...
/* harmony import */ var _modules_init_nav_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-nav-menu */ "./js/modules/init-nav-menu.js");
...
/* harmony import */ var _modules_stop_transition_resize__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/stop-transition-resize */ "./js/modules/stop-transition-resize.js");
...
Object(_modules_init_nav_menu__WEBPACK_IMPORTED_MODULE_3__["initNavMenu"])();
Object(_modules_show_content__WEBPACK_IMPORTED_MODULE_5__["showContent"])();
Object(_modules_stop_transition_resize__WEBPACK_IMPORTED_MODULE_6__["stopTransitiononResize"])();
...
var initNavMenu = function initNavMenu() {
  ...
  if (navMenu && navMenuBtn) {
    navMenuBtn.addEventListener('click', function (evt) {
      evt.preventDefault();
...
var blockBtn = document.querySelector('.main-block__btn');
...
var stopTransitiononResize = function stopTransitiononResize() {
  var resizeTimer;
  window.addEventListener('resize', function () {
